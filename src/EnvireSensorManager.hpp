...
#ifndef ENVIRE_SENSOR_MANAGER_H
#define ENVIRE_SENSOR_MANAGER_H

#ifdef _PRINT_HEADER_
  #warning "EnvireSensorManager.h"
#endif
...
namespace mars {
  namespace plugins {
     ...
     */
    class EnvireSensorManager : public interfaces::SensorManagerInterface {
    public:
       ...
       */
      EnvireSensorManager(mars::interfaces::ControlCenter *c);

      /**
       * \brief Destructor.
       */
      virtual ~EnvireSensorManager(){}
       ...
       */
      virtual void getListSensors(std::vector<mars::interfaces::core_objects_exchange> *sensorList) const;
       ...
       */
      virtual const mars::interfaces::BaseSensor* getFullSensor(unsigned long index) const;
       ...
       */
      virtual mars::interfaces::BaseSensor* getSimSensor(unsigned long index) const;
       ...
       */
      virtual int getCameraSensor(mars::interfaces::cameraStruct *cs, int index) const;
#endif
       ...
       */
      virtual int getSensorData(unsigned long id, mars::interfaces::sReal **data) const;
      ...
      void addSensorType(const std::string &name, mars::interfaces::BaseSensor* (*func)(mars::interfaces::ControlCenter*, mars::interfaces::BaseConfig*));

      //void addQdomParser(const std::string, BaseConfig* (*)(QDomElement*));
      void addMarsParser(const std::string, mars::interfaces::BaseConfig* (*)(mars::interfaces::ControlCenter*, configmaps::ConfigMap*));
      ...
      virtual interfaces::BaseSensor* createAndAddSensor(const std::string &type_name, mars::interfaces::BaseConfig *config, bool reload=false);
    ...
    private:
      ...
      std::map<const std::string, mars::interfaces::BaseSensor* (*)(mars::interfaces::ControlCenter*, mars::interfaces::BaseConfig*)> availableSensors;

      //std::map<const std::string,BaseConfig* (*)(QDomElement*)> qDomParser;
      std::map<const std::string, mars::interfaces::BaseConfig* (*)(mars::interfaces::ControlCenter*, configmaps::ConfigMap*)> marsParser;

    }; // class EnvireSensorManager

    } // end of namespace envire_managers
  } // end of namespace plugins
} // end of namespace mars

#endif  // ENVIRE_SENSOR_MANAGER_H
